<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Sign_Up.aspx.cs" Inherits="Pages_Sgin_Up" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="box-4 login_section">
        <div class="login">
            ...
            <asp:TextBox class="login_input_box" Style="padding: 5px; margin-right: 60px; width: 170px;" ID="first_name" runat="server"
                placeholder=" Enter First Name" ></asp:TextBox>
            <asp:TextBox Style="padding: 5px; width: 170px;" ID="last_name" runat="server" placeholder=" Enter First Name" ></asp:TextBox>
            ...
            <asp:TextBox Style="padding: 5px; margin-right: 190px;" ID="email" TextMode="Email" runat="server" placeHolder=" Enter Email"></asp:TextBox>
            ...
            <asp:Button ID="sign_in" runat="server" Text="sgin in" class="login_btn" OnClick="sign_in_Click" />
